...
function TestSpell(props: Props) {
    ...
    let spellColor = stringers.schoolStringifyColorsPure(currentSpell.school)

    let borderColor = spellColor;
    if (school == "Necromancy")
        borderColor = "#fff"

    return (
        <table id="test-spell">
            <th id="spell-name-div" style={{
                borderColor: spellColor,
                color: textColor,
            }}>
                <div id="spell-level" style={{
                    backgroundColor: spellColor,
                    color: textColor
                }}>
                    {level}
                </div>
                <div id="spell-name" style={{ color: borderColor }}>
                    {currentSpell.name}
                </div>
                <div id="spell-school" style={{ color: borderColor }}>
                    {school}
                </div>
            </th>
            <tr id="spell-info-container">
                <div id="spell-casting-time">
                    {time}
                </div>
                <div id="spell-components">
                    {components}
                </div>
                <div id="spell-duration">
                    {duration}
                </div>
            </tr>
            <tr id="spell-description" style={{ borderColor: borderColor }}>
                {description}
            </tr>
            <tr id="spell-higher-level" style={{ borderColor: borderColor }} >
                {higherLevel}
            </tr>
